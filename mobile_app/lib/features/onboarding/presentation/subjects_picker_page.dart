  ...
  Widget _dispatchByPickerMode({
    ...
    switch (profile.pickerMode) {
      ...
      case PickerMode.seriesPlusOptional:
        // Story 1.16 a implementer : A-Level transversales (James Upper Sixth
        // + ICT). En attendant, redirect recap defensive.
        AppLogger.i(
          'PickerPage: pickerMode=seriesPlusOptional (Story 1.16) '
          'redirect recap',
        );
        WidgetsBinding.instance.addPostFrameCallback((_) {
          if (context.mounted) {
